...
public class ClassUtils {
    ...
    public static Class forName(String className, boolean initialize) {
        try {
            ...
            throw new BedpodRuntimeException(e);
        }
    }
     ...
     * @param <T>      对象具体类
     * @return 对象实例
     * @throws BedpodRuntimeException 没有找到方法，或者无法处理，或者初始化方法异常等
     */
    public static <T> T newInstanceWithArgs(Class<T> clazz, Class<?>[] argTypes, Object[] args)
        throws BedpodRuntimeException {
        ...
        try {
            if (!(clazz.isMemberClass() && !Modifier.isStatic(clazz.getModifiers()))) {
                ...
                if (constructors == null || constructors.length == 0) {
                    throw new BedpodRuntimeException("The " + clazz.getCanonicalName()
            ...
            throw new BedpodRuntimeException(e.getMessage(), e);
        }
    }
     ...
     * @throws BedpodRuntimeException 没有找到方法，或者无法处理，或者初始化方法异常等
     */
    public static <T> T newInstance(Class<T> clazz) throws BedpodRuntimeException {
